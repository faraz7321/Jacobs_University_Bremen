...
SuperClass::SuperClass() {
    cout << "Overriding Constructor for SuperClass. Constructor of SuperClass called." << endl;
}
...
******************************************************************/
SuperClass::~SuperClass() {
    cout << "Overriding Destructor for SuperClass. Destructor of SuperClass called." << endl;
}
