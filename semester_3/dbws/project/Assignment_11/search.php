    ...
    <div class="page">
        <div class="maintenance">
            <ul style="margin-left:200px;">
                <li>
                    <a href="search_php_scripts/items.php"> Search Items </a>
                </li>

                <li>
                    <a href="search_php_scripts/employees.php"> Search Employees </a>
                </li>

                <li>
                    <a href="search_php_scripts/departments.php"> Search Departments </a>
                </li>
