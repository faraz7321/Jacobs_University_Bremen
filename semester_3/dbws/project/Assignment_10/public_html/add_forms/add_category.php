...
<body>
    ...
    <div class="page">
        <div class="form">
            <h1 style="text-decoration: underline;">Create a New Category</h1>
            <form action="../add_php_scripts/category.php" method="post">
                <input type="text" name="name" placeholder="Category Name" required>
                <input type="number" name="num_of_items" placeholder="Number of Items" required>
                <input type="submit" value="Add" style="margin-left: 275px;" name="submit">
