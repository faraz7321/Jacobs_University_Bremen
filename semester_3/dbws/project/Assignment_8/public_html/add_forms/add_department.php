...
<body>
    ...
    <div class="page">
        <div class="form">
            <h1 style="text-decoration: underline;">Create a New Department</h1>
            <form action="../add_php_scripts/department.php" method="post">
                <input type="text" name="name" placeholder="Department Name" required>
                <input type="number" name="num_of_emps" placeholder="Number of Employees" required>
                <input type="submit" value="Add" style="margin-left: 400px;" name="submit">
