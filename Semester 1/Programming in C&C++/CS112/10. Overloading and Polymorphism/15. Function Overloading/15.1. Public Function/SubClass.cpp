...
void SubClass::protectedsuperfunc() {
    cout << "I am function of SubClass and have overridden the protected function of SuperClass." << endl;
}

void SubClass::publicsuperfunc() {
    cout << "I am function of SubClass and have overridden the public function of SuperClass." << endl;
}
